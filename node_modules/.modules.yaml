...
hoistedDependencies:
  ...
  '@vitest/mocker@2.1.9(vite@5.4.19(@types/node@20.19.11))':
  ...
  vite@5.4.19(@types/node@20.19.11):
    vite: private
  vitest@2.1.9(@types/node@20.19.11):
    vitest: private
  which@2.0.2:
    which: private
...
pendingBuilds: []
prunedAt: Fri, 15 Aug 2025 16:53:03 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
